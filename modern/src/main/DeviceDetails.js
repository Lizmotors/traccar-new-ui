...
const DeviceDetails = props => {
  ...
  return (
    <PageLayout
      ...
      <div
        style={{
          backgroundColor: isDarkMode ? '070818' : '#F5F5F7',
        ...
        <Grid container spacing={2} sx={{ minHeight: 'calc(100vh - 120px)' }}>
          ...
          <Grid item xs={12} md={9}>
                  ...
                  <Card
                    ...
                    <CardContent>
                      ...
                      <Typography
                        ...
                        className={classesStyles.cardTextValue}>
            ...
            {/* </Grid> */}
            {/* </Grid> */}
            {/* this is the table for the device details */}
                      ...
                      <div className={classes.container}>
                        ...
                        <div className={classes.containerMain}>
                          <div className={classes.header}>
                            <ReportFilter
                              className={classes.filterDeviceDetails}
                              ignoreDevice={true}
                              includeFilters={true}
